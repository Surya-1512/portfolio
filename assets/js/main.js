...
/*==================== TESTIMONIALS MODAL ====================*/
const testimonialViews = document.querySelectorAll('.testimonials__modal'),
      testimonialBtns = document.querySelectorAll('.testimonials__button'),
      testimonialCloses = document.querySelectorAll('.testimonials__modal-close');

let testimonial = function(testimonialClick){
    testimonialViews[testimonialClick].classList.add('active-modal');
}
